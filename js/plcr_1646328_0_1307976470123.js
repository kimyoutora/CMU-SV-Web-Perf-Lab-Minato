              ...
              function PlacementCreative_1307976469847(creative) {
                ...
                this.exitEvents["TRANSFORMERS3_2011_500x250_EXIT"] = {
                    reportingId: 582095,
                ...
                this.childAssets = new Object();
                  this.childAssets["Transformers3_2011_500x250_expanded.swf"] = {
                    isHostedByCdn: false,
                    cdnName: "PID_1646328_Transformers3_2011_500x250_expanded.swf",
                    isVideo: false,
                    streamingUrl: "",
                    progressiveUrl: ""
                  }
                  this.childAssets["Transformers3_2011_500x250_collapsed.swf"] = {
                    isHostedByCdn: false,
                    cdnName: "PID_1646328_Transformers3_2011_500x250_collapsed.swf",
                    isVideo: false,
                    streamingUrl: "",
                    progressiveUrl: ""
                  }
              ...
              function Expanding_1307976469847(creative, type, coreCode) {
                ...
                this.url = creative.mediaServer + "/2812300/PID_1646328_Transformers3_2011_500x250_parent.swf";
                this.duration = "none";
                this.startTime = "0";
              ...
              function ExpandingHTML_1307976469847(creative, type, coreCode) {
                this.getExpandingDivStyleSheet = function(cssKeyValues) {
                  if(cssKeyValues == "") {
                    return "";
                  }
              ...
              if(typeof(richMediaIFrameCreatives) != "undefined" && richMediaIFrameCreatives["1307976469847"]) {
                ...
                var creative = new PlacementCreative_1307976469847(baseCreative);
                var isFlashAssetExist = true;
                if(creative.shouldDisplayFlashAsset) {
                  creative.assets[core.ASSET_TYPE_EXPANDING] = new Expanding_1307976469847(creative, core.ASSET_TYPE_EXPANDING, core);
                ...
                if(creative.forceHTML5Creative || creative.isHTML5PreviewMode || !creative.shouldDisplayFlashAsset || !isFlashAssetExist) {
                  ...
                  creative.assets[core.ASSET_TYPE_EXPANDING] = new ExpandingHTML_1307976469847(creative, core.ASSET_TYPE_EXPANDING, core);
                }
                self.richMediaIFrameCreatives["1307976469847"].creative = creative;
                var iframeRenderer = new IFrameCreativeRenderer_60_10();
                iframeRenderer.showCreative("1307976469847");
              } else {
                var core = new RichMediaCore_60_10();
                var baseCreative = new RichMediaCreative_1307976469847(core.CREATIVE_TYPE_EXPANDING);
                var creative = new PlacementCreative_1307976469847(baseCreative);
                var isFlashAssetExist = true;
                if(creative.shouldDisplayFlashAsset) {
                  creative.assets[core.ASSET_TYPE_EXPANDING] = new Expanding_1307976469847(creative, core.ASSET_TYPE_EXPANDING, core);
